...
対して$\alpha_{i-1} \rightarrow \alpha_i$であって$\alpha_i \rightarrow \alpha_{i-1}$や$\alpha_i \leftrightarrow \alpha_{i-1}$で  
ないとき、つまり  
...
竹内他（1989）『統計学辞典』  
「一言でいえば、  
諸**原因**系が**結果**の特製地に及ぼす**影響**を解明すること」
</div> 
...
* $n_j$人の個体に処理条件$x_j$を割り当てると$(j=1,\cdots,k_)$$M$通り
...
* 完全ランダム化
  * $X=x_j$を割り当てる個体の数があらかじめ決まっている場合に適用可能
  * 最後の1人に割り当てられる値は一意に決まるという欠点
...
* ランダムな交絡➡︎起こる可能性小さいことが起こった
  * 「ランダムな交絡が生じている場合には、因果効果を適切に評価することが難しい」という立場が大勢
