...
(式(6.7) を $N\left(\mu_1,\sigma^2_1\right)$ の確率密度で割れば良い)
...
$N\left(\mu,\sigma^2\right)$ からの無作為標本 $X_1,\dots,X_n$ に対し、標本平均を $\bar{X}$、不偏分散を $s^2 = \sum^{n}_{i = 1}\frac{\left(X_i - \bar{X}\right)^2}{n-1}$ とすると、
